...
const HaversineDistance = (A, B) => {
    ...
    return 637100 * 2 * Math.atan2(Math.sqrt(a), Math.sqrt(1 - a));
};
...
const GeographicToEuclidean = (geo) => {
	...
	const x = lonRad * 637100;
    const y = Math.log(Math.tan(Math.PI / 4 + latRad / 2)) * 637100;
...
const ParkingRoadInterpolate = (A, B, fraction) => {
    ...
    const d = HaversineDistance(A.lat, A.lon, B.lat, B.lon) / 637100;
